...
const SUB_DESC = {
  ...
  "2D Fighting": "Side-view duels with combos & special moves.",
  "3D Fighting": "Free-roaming duels with ring-outs & arenas.",
  "Arena Fighting": "Free-for-all in confined arenas; power-ups.",
  "Platform Fighter": "Platforming stages with fighting mechanics.",
  "Logic": "Pattern recognition, sequences, and deduction.",
  "Physics": "Environment-based puzzles using physics principles.",
  "Match-3": "Tile-matching with combos and power-ups.",
  "Hidden Object": "Find listed items in detailed scenes.",
  "Open World": "Large, explorable worlds with emergent gameplay.",
  "Creative Sandbox": "Player creativity with building and tools.",
  "Survival Sandbox": "Resource gathering, crafting, and base-building.",
  "Life Simulation": "Daily life activities, relationships, and routines.",
  "Management": "Oversee systems, economies, or operations.",
  "Vehicle Simulation": "Realistic vehicle operation and physics.",
  "Action RPG Soulslike": "Challenging combat with RPG progression.",
  "2D Soulslike": "Side-scrolling with soulslike mechanics.",
  "Metroidvania Soulslike": "Exploration with ability-gated progression.",
  "Football/Soccer": "Team-based football/soccer matches.",
  "Basketball": "Team-based basketball matches.",
  "Arcade Sports": "Fast-paced, exaggerated sports action.",
}
